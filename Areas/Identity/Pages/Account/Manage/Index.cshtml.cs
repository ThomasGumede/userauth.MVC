...
using userauth.MVC.Models;


namespace userauth.MVC.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Request.Form.Files.Count > 0)
            {
                ...
                var basePath = Path.Combine(_webHostEnvironment.WebRootPath + "/Profile/");
                ...
                if (!System.IO.File.Exists(filePath))
                {
                    ...
                    user.ProfilePicture ="Profile/" + file.FileName;
                }
